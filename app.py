...
from services.personServices import register_user, get_user, check_user, confirm_email, confirm_person, get_all, remove_user, get_checked_in
import gunicorn
...
@key_required
@app.route('/person/get_checked_in',methods=['GET'])
def get_checked():
    return get_checked_in()